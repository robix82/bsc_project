...
I chose \emph{MySql} for this purpose because I already had some experience with it, and there is a lot of documentation online on how to 
interact with it from a \emph{SpringBoot} application.

\subsubsection{\textbf{Integrating \emph{Lucene} indexing and retrieval}}

\subsubsection{\textbf{Application-level multi language support}}

\subsubsection{\textbf{Corpus-level multi language support}}
