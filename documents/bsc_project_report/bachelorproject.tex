...
\abstract { 
     ...
     In this project we implement a software toolkit needed for an experiment planned by the \newline
    ...
    and setting up an experimental environment allowing to conduct controlled experiments (e.g. prevent participants from
...
I see myself as a technician, who in the area of software development seeks to build useful applications.
...
%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{enumerate}
        ...
        \item \textbf{(Must have)} A website that simulates a search engine that lets users enter keywords into a search form and
        ...
        \item \textbf{(Must have)} A report describing the system's setup/installation and architectural design. 
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{figures/usage}
...
The U.I. for experiment setup allows defining the details of an experiment to be carried out. This step involves creating
...
The U.I. for experiment execution includes a start/stop/reset button, a timer, and a tabular display 
...
or preprocessed data summaries. The UI includes visualizations of the most relevant data features.
